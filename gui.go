...
func drawFreeSpaceTable(g *gocui.Gui) error {
	...
	for {
		...
		g.Update(func(g *gocui.Gui) error {
			...
			chia_probability_formula := 1 - ((1 - (len(res.Plots)*102/1024)/int((float64(returnBlockChainDetails())*1152921.504606847))) ^ 4608)
			...
			fmt.Fprintf(v, "\u2705 Chance to win chia today :\033[34mUSD %d\033[0m\n", chia_probability_formula)
